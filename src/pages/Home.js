        ...
        <div>
            ...
            <div class="container px-4 py-5" id="featured-3">
                <section className="py-4" id="about">
                    ...
                    <div className="row my-1 mx-auto p-3">
                        <div className="col-md-4 col-lg-6 text-center p-3">
                            <img
                                className=""
                        ...
                        <div className="col-md-8 col-lg-6 p-3">
                            <div className="pt-3 h-100">
                                ...
                                <p className="plain-text">
                                    Exercitation nostrud ut tempor velit duis
                                    dolore minim mollit. In consectetur dolore
                                    deserunt ut consequat dolor est irure qui.
                                    Dolore ut ex et voluptate ut officia ex est.
                                </p>
                                <p>
                                    Cillum est duis id ad. Duis duis irure aute
                                    officia et ex id mollit magna. Proident
                                    excepteur eu ex cillum amet sit pariatur.
                                    Excepteur anim laborum ea duis laboris
                                    deserunt.
                                </p>
                            </div>
                        </div>
